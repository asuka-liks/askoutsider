    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          id: 'imitator',
          title: '模仿吵架大师',
          summary: 'AI 模仿对方语气帮你回怼的聊天应用。五种吵架风格，火力全开。',
          tags: ['AI', 'Node.js', '交互'],
        },
      ],
    },
  ...
  en: {
    ...
    projects: {
      ...
      items: [
        ...
        {
          id: 'imitator',
          title: 'Imitation Roast Master',
          summary: "AI-powered chat app that mimics your opponent's tone and roasts them back. Five roast styles, no mercy.",
          tags: ['AI', 'Node.js', 'Interactive'],
        },
      ],
    },
    contact: {
